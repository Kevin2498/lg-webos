    ...
    var inspector = {
        ...
        inspect: function(options, params, next) {
            ...
            function _runApp(next) {
                ...
                launcher.listRunningApp(options, null, function(err, runningApps) {
                    var strRunApps = "";
                    var cnt = 0;
            ...
            function _runServicePortForwardServer(next) {
                ...
                function __eachServicePortForward(serviceId, next) {
                    ...
                    var __luanchServiceInspector = function (svcId, next) {
                    ...
                    async.waterfall([
                        ...
                        __luanchServiceInspector.bind(this, serviceId)
            ...
            function _runAppInspector(next) {
                if (options.appId) {
                    ...
                    if(options.session.target.noPortForwarding){
                        ...
                        url = "http://" + options.session.target.host + ":9998";
                    }
